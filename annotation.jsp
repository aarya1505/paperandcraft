...
<body>
    ...
    <div class="card">
            <div class="image">
                <img src="images/ann1.jpg">
            </div>
            <div class="title">
                <h2>Stabilio Highlighters</h2>
            </div>
            <div class="des">
                <p>₹350</p>
        ...
        <div class="card">
            <div class="image">
                <img src="images/ann3.jpg">
            </div>
            <div class="title">
                <h2>Faber Castell Highlighters</h2>
            </div>
            <div class="des">
                <p>₹60</p>
                <form action="AddToCartServlet" method="POST">
        ...
        <div class="card">
            <div class="image">
                <img src="images/ann4.jpg">
            </div>
            <div class="title">
                <h2>Pencil Highlighters</h2>
            </div>
            <div class="des">
                <p>₹290</p>
                <form action="AddToCartServlet" method="POST">
        ...
        <div class="card">
            <div class="image">
                <img src="images/ann11.jpg">
            </div>
            <div class="title">
                <h2>Transparent Sticky Notes</h2>
            </div>
            <div class="des">
                <p>₹200</p>
                <form action="AddToCartServlet" method="POST">
        ...
        <div class="card">
            <div class="image">
                <img src="images/ann12.jpg">
            </div>
            <div class="title">
                <h2>Sticky Notepads</h2>
            </div>
            <div class="des">
                <p>₹150</p>
                <form action="AddToCartServlet" method="POST">
